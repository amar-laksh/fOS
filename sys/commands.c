...
marry_song()
{
  char notes[26] = { 'E', 'D', 'C', 'D', 'E', 'E', 'E', 'D', 'D',
                     'D', 'E', 'E', 'E', 'E', 'D', 'C', 'D', 'E',
                     'E', 'E', 'E', 'D', 'D', 'E', 'D', 'C' };
  for (int i = 0; i < 26; ++i) {
    play_note(notes[i], 6, 1);
...
void*
memset_h(void* dest, int16_t val, size_t count)
{
...
{
  char* fb = (char*)VIDMEM;
  if (vga_fb.array_offset != VIDMEM_SIZE && vga_fb.vga_offset != 0) {
...
resume()
{
  ...
  read_text(
    ptr, (memory_t.modules[1].module_end - memory_t.modules[1].module_start));
here:
