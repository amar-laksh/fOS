...
PCI_DEVTABLE device_table[] = {
  ...
  { 0x5333,
    0x8901,
    "pci\ven_5333dev_8C2E&SUBSYS_00011179&REV_05\4&74C6",
  ...
  { 0x8086,
    0x2415,
    "Intel 82801DBM SM/BUS Controller 24C3",
  ...
  { 0x8086,
    0x2592,
    "Intel 82852/82855 Graphic controller family",
  ...
  { 0x8086,
    0x266E,
    "Intel Corporation  82830M/MG SDRAM Controller / Ho",
  ...
  { 0x8086,
    0x2822,
    "82801HR/HH/HO&82801IR/IH/IO(AIE=0)/ICH10R",
    "Raid Controller" },
  ...
  { 0x8086,
    0x29a1,
    "?(82Q965, 82G965, 82P965)",
    "Intel P965/G965 PCI Express Root Port" },
  { 0x8086,
    0x29A4,
    "n/a",
    "The Intel Management Engine provides thermal management for Intel Desktop "
    "Boards." },
  ...
  { 0x1734,
    0x1012,
    "CSB6",
    "Serverworks Southbridge with RAID/IDE (rev a0), OHCI USB (rev 05), GCLE-2 "
    "Host Bridge" },
  ...
  { 0x1814,
    0x0302,
    "RT2525 2.4GHz transceiver + RT2560 MAC/BBP",
    "wireless a/b" },
  ...
  { 0x168C,
    0x001c,
    "VEN_10DE&DEV_0649&SUBSYS_059717FF&REV_A14&2DEFBOA",
  ...
  { 0x16EC,
    0x2F00,
    "USRobotics 5660A - Internal Soft Modem",
  ...
  { 0x0E11,
    0xF095,
    "FCA2101",
    "HP StorageWorks 2 Gb, 64-Bit/66-MHz PCI-to-Fibre Channel Host Bus Adapter "
  ...
  { 0x1000,
    0x0021,
    "LSI53C1000/1000R/1010R/1010-66",
  ...
  { 0x1002,
    0x4758,
    "210888GXControladores ATI 210888GX [Mach64 GX]",
    "Mach 64 GT" },
  ...
  { 0x1002,
    0x4C50,
    "VEN_1002&DEV_4C50&SUBSYS_4C501002&REV_DC",
    "Rage 3D LT Pro PCI" },
  ...
  { 0x1002,
    0x4C66,
    "ATI MOBILITY RADEON 9000 (Microsoft Corporation -",
    "Radeon Mobility M9" },
  ...
  { 0x1002,
    0x5049,
    "bk2.0.2.vr001.001.002.002.004.025.prt3.ty.t",
  ...
  { 0x1002,
    0x5050,
    "Scheda Grafica Standard PCI(VGA)",
  ...
  { 0x1002,
    0xAA01,
    "Ati Function driver for high definition audio - AT",
  ...
  { 0x166D,
    0x0002,
    "BCM1125/BCM1250 HyperTransport Configuration Heade",
  ...
  { 0x1039,
    0x6330,
    "SiS661FX/M661FX/760/741/M760/M741",
  ...
  { 0x104C,
    0x803B,
    "PCIxx12 VEN_104C&DEV_803B&SUBSYS_0753152D&REV_00\4",
  ...
  { 0x1057,
    0x3057,
    "HDAUDIOFUNC_02&VEN_1057&DEV_3057&SUBSYS_00010001&",
  ...
  { 0x13C0,
    0x00a0,
    "SyncLink GT2 Adapter",
    "2 port multiprotocol serial adapter" },
  { 0x13C0,
    0x0210,
    "SyncLink Serial Adapter version 2",
    "single port multiprotocol serial adapter" },
  ...
  { 0x13F6,
    0x111,
    "PCIVEN_13F6&DEV_0111&SUBSYS_011113F6&REV_102&EBB",
  ...
  { 0x5555,
    0x0003,
    "VPI General Digital Video Component",
  ...
  { 0x109E,
    0x109E,
    "Brooktree Corp BT848 SVR-2000 V1.02",
  ...
  { 0x10B5,
    0x8111,
    "PEX 8111, PEX 8311",
    "1 Lane PCI Express to PCI bridge (PEX8111); 1 Lane PCI Express to Generic "
    "Local Bus bridge (PEX8311)" },
  ...
  { 0x10BD,
    0x0803,
    " MYSON Technology Inc SURECOM EP-320X-S 100/10M Et",
  ...
  { 0x10BD,
    0x8139,
    "surecom EP-320X-R adapter with realtek 8139c chip",
    "realtek 8139c" },
  ...
  { 0x10DE,
    0x0003,
    "It seems to be Realtek ALC888/9",
  ...
  { 0x10DE,
    0x0057,
    "nForce4 Ultra",
    "NVidia Network Bus Enumerator Description du p�riph�rique	nVIDIA nForce4 "
    "SLI (CK8-04) - LAN Controll" },
  ...
  { 0x10EC,
    0x8136,
    "RTL8100-8101E-8102E-PCIEXPRESS",
  ...
  { 0x1106,
    0x3038,
    "VT83C572/6202/82C586A/B/82C596/A/B/82C686A/B etc",
    "USB&UHCI" },
  ...
  { 0x1106,
    0x3107,
    "VT8233/A AC97' Enhance Audio Controller",
    "PCI to ISA Bridge" },
  { 0x1106,
    0x3108,
    "Unknown",
  ...
  { 0x1106,
    0x3198,
    "VEN_1106&DEV_B198&SUBSYS_00000000&REV_00",
    "CPU-to-PCI Bridge" },
  ...
  { 0x13F0,
    0x13F0,
    "-PCIVEN_13F0&DEV_1023&SUBSYS_81801043&REV_414&BC",
  ...
  { 0x1409,
    0x7268,
    "PCI / ISA IEEE1284 ECP/EPP/SPP/BPP Signal Chips So",
    "PCI parallel port" },
  { 0x140B, 0x0610, "", "" },
  { 0x140B, 0x615, "NA", "Na" },
  { 0x140B, 0x682, "NA", "NA" },
  ...
  { 0x14E4,
    0x5805,
    "BCM5805",
    "The BCM5805 Security Processor integrates a high-performance IPSec engine "
    "(DES, 3DES, HMAC-SHA-1, HM" },
  ...
  { 0x1179,
    0x0805,
    "PCIVEN_1180&DEV_0592&SUBSYS_828D1033&REV_064&5A9",
    "SD Card Controller" },
  ...
  { 0x1186,
    0x1300,
    "DL10038C or DL10038D (Remark of Realtek RTL-8139)",
  ...
  { 0x1186,
    0x3300,
    "D-Link Air Wireless Network (DWL-G510)",
  ...
  { 0x11AB,
    0x4353,
    "88E8039 - http://www.marvell.com/drivers/driverDis",
    "Gigabit" },
  { 0x11AB,
    0x4354,
    "88E8040",
  ...
  { 0x11C1,
    0x0464,
    "This is NOT a Riptide! (as previously stated)",
...
// Use this value for loop control during searching:
#define PCI_CLASS_CODE_TABLE_LEN                                               \
  (sizeof(class_code_table) / sizeof(PCI_CLASSCODETABLE))
